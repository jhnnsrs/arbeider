...
import xarray as xr
from filters.logic.default import FilterNode

class Prewitt(FilterNode):
...
class Mapping(FilterNode):
    ...
    def filter(self, array: xr.DataArray, settings: dict) -> xr.DataArray:
        ...
        x = xr.DataArray(x, dims=threed.dims, coords={**threed.coords, "c": range(3)})
