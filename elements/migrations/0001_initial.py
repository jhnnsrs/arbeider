    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('channels', matrise.mixins.ChannelsField(blank=True, null=True)),
                ('planes', matrise.mixins.PlanesField(blank=True, null=True)),
                ...
                ('shape', matrise.fields.ShapeField(base_field=models.IntegerField(), blank=True, help_text='The arrays shape', null=True, size=None)),
                ('dims', matrise.fields.DimsField(base_field=models.CharField(max_length=100), blank=True, help_text='The arrays dimension', null=True, size=None)),
